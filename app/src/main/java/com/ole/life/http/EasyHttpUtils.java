...
import com.ole.life.http.interceptor.CustomSignInterceptor;
...
//        headers.put("User-Agent", SystemInfoUtils.getUserAgent(this, AppConstant.APPID));
        ...
        EasyHttp.getInstance()
                //可以全局统一设置全局URL
                .setBaseUrl("")//设置全局URL  url只能是域名 或者域名+端口号
                .addCommonHeaders(UrlConfig.getCommonHeaders()) //添加全局请求头
                .addCommonParams(params)  //添加全局参数
...
//                .addCommonParams(params)//设置全局公共参数
                .addNetworkInterceptor(new StethoInterceptor())//设置网络拦截器
                ...
                //.addInterceptor(new MyTokenInterceptor())//网络操作的token等验证处理

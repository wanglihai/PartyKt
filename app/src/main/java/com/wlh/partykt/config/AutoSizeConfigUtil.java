...
public class AutoSizeConfigUtil {

    /**
     * 屏幕适配方案的基本设置
     * @param application
     */
    public static void setAutoSizeConfig(Application application){
        ...
        AutoSizeConfig.getInstance()
                ...
                .setOnAdaptListener(new onAdaptListener() {
                    ...
                    public void onAdaptBefore(Object target, Activity activity) {
                        ...
                        KLog.d(String.format(Locale.ENGLISH, "%s onAdaptBefore!", target.getClass().getName()));
                    }

                    @Override
                    public void onAdaptAfter(Object target, Activity activity) {
                        KLog.d(String.format(Locale.ENGLISH, "%s onAdaptAfter!", target.getClass().getName()));
                    }
                })
